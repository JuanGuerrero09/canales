...
class CustomEntry(tk.Entry):
    ...
    def foc_out(self, *args):
        if self.get() == "" and self['state'] == 'normal':
...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.entry1 = CustomEntry(self, state="disabled", placeholder='entry')
        self.entry2 = CustomEntry(self, state="disabled", placeholder='entry')
        self.entry3 = CustomEntry(self, state="disabled", placeholder='entry')
